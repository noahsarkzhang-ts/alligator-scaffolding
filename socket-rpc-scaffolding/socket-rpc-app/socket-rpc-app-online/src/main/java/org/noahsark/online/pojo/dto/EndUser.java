...
public class EndUser implements Serializable {
    ...
    public EndUser(String userId, short type) {
        ...
        this.clientType = ClientTypeConstants.getDefaultClientType(type);
    }

    public EndUser(String userId, short type, short clientType) {
        this.userId = userId;
        this.type = type;

        this.clientType = ClientTypeConstants.getDefaultClientType(clientType, type);
    }
